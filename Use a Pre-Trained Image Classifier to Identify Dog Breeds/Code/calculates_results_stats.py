...
def calculates_results_stats(results_dic):
    ...
    """        
    # Initialize the results_stats_dic, setting all statistics to 0 or 0.0 (int or float)
    ...
    for image in results_dic:
        ...
        # Check if it matched it as a dog
        if results_dic[image][3] == 1:
            results_stats_dic["n_dogs_img"] += 1
        else:
            results_stats_dic["n_notdogs_img"] += 1
        
        # Check if there was a match between pet and classification label
        if results_dic[image][2] == 1:
            results_stats_dic["n_match"] += 1
        
        # Check is-a-dog matches classification output as-a-dog
        if results_dic[image][3] == 1 and results_dic[image][4] == 1:
            results_stats_dic["n_correct_dogs"] += 1

        # Check is-not-a-dog matches classification output as-not-a-dog
        if results_dic[image][3] == 0 and results_dic[image][4] == 0:
            results_stats_dic["n_correct_notdogs"] += 1
        
        # Check if the dog matches and if the labels match
        if results_dic[image][2] == 1 and results_dic[image][3] == 1 and results_dic[image][4] == 1:
    ...
    #Avoid Division by Zero Error for n_notdogs_img variable
